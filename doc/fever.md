...
The Fever API implemented by Assurcast Reader is inherited from upstream [narr](https://github.com/fiatjaf/narr) and based on the Fever API spec: https://github.com/DigitalDJ/tinytinyrss-fever-plugin/blob/master/fever-api.md.

Here are some Apps that have been tested to work with Assurcast Reader. Feel free to test other Clients/Apps and update the list here.
